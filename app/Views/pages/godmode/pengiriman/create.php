    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="mb-0">Tambah Pengiriman Baru</h5>
            </div>
        </div>
        <div class="card-body">
            <form action="<?= base_url('godmode/pengiriman/store') ?>" method="post" class="needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control <?= session('errors.tanggal_kirim') ? 'is-invalid' : '' ?>" id="tanggal_kirim" name="tanggal_kirim" value="<?= old('tanggal_kirim') ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control <?= session('errors.tanggal_terima') ? 'is-invalid' : '' ?>" id="tanggal_terima" name="tanggal_terima" value="<?= old('tanggal_terima') ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control <?= session('errors.deskripsi') ? 'is-invalid' : '' ?>" id="deskripsi" name="deskripsi" rows="10" placeholder="Detail pengiriman, catatan khusus, dll..."><?= old('deskripsi') ?></textarea>
