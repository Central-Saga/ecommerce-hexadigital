...
<div class="kategori-form">
    <div class="card">
        ...
        <div class="card-body">
            <form action="/godmode/kategori/update/<?= $kategori['id'] ?>" method="POST" class="needs-validation" novalidate>
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                rows="4"><?= old('deskripsi_kategori', $kategori['deskripsi_kategori']) ?></textarea>
                            <div class="invalid-feedback">
